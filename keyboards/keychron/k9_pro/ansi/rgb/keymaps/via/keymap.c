...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_61_ansi(
        ...
        KC_GRV,  LCTL_T(KC_A), LALT_T(KC_S),   LGUI_T(KC_D),   LSFT_T(KC_F),   KC_G,     KC_H,     RSFT_T(KC_J),   RGUI_T(KC_K),   LALT_T(KC_L),   RCTL_T(KC_SCLN),    KC_QUOT,            KC_ENT,
        KC_LSFT,                KC_Z,           KC_X,           KC_C,           KC_V,     KC_B,     KC_N,           KC_M,           KC_COMM,        KC_DOT,             KC_SLSH,            KC_RSFT,
        KC_LCTL,  KC_LOPTN,     MO(L_NUMS),                         LT(4, KC_SPC),                                                  KC_RCMMD,   MO(MAC_FN), MO(L_FN1),  KC_RCTL),
    ...
    [WIN_BASE] = LAYOUT_61_ansi(
        ...
        KC_LSFT,                KC_Z,           KC_X,           KC_C,           KC_V,     KC_B,     KC_N,           KC_M,           KC_COMM,        KC_DOT,             KC_SLSH,            KC_RSFT,
        KC_LCTL,  KC_LWIN,      KC_LALT,                            LT(4, KC_SPC),                                                  KC_RALT,    MO(WIN_FN), MO(L_FN1),  KC_RCTL),
    ...
    [L_NUMS] = LAYOUT_61_ansi(
        _______,  KC_F1,      KC_F2,  KC_F3,    KC_F4,    KC_F5,     KC_F6,   KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,
        _______,  KC_MS_BTN1, KC_7,   KC_8,     KC_9,     KC_0,      _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,
...
// !!! new glitch: d => a sometimes produces cmd + a !!!
